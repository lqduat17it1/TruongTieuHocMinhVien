...
<html  lang="en-US">
  ...
  <head id="Head">
    ...
    <link href="resource/Portals/_default/skins/minhvien/skin4b95.css?cdv=118" type="text/css" rel="stylesheet"/>
  </head>
  <body id="Body">
                    ...
                    <div class="wd-list-box">
                      <span id="dnn_ctr1915_View_lblTintuc">
                        <div class='wd-content-detail'>
                            <img src="resource/Images/so_do_co_cau_to_chuc.jpg" style="width: 100%" />                          
                        </div>
                      </span>
                    </div>
                  </div>
